...
This repo demonstrates how to add authentication into an iOS apps using Authgear.
...
To do this, in `ContentView.swift`, replace `"<ClIENT_ID>"`, `"<AUTHGEAR_ENDPOINT>"` with with your own Authgear application credentials.
